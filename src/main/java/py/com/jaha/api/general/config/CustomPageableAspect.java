...
import static py.com.jaha.api.general.constants.GlobalConstants.PARAM_PAGE_KEY_NAME;
import static py.com.jaha.api.general.constants.GlobalConstants.PARAM_PAGE_SIZE_NAME;
...
import py.com.jaha.api.general.commons.ApiPageableResponse;
import py.com.jaha.api.general.commons.CustomPagination;

@Aspect
@Component
public class CustomPageableAspect {

  @Around("@annotation(py.com.jaha.api.general.config.CustomPageable) && execution(py.com.jaha.api.general.commons.ApiPageableResponse+ *(..)) && args(page, ..)")
